...
const SliderInner = (props) => {
  ...
  className={style.kc_slider_container}>
    <div ref={slider} className={style.kc_slider}>
      ...
      {props.children.map((e,i)=><Item rtl={props.rtl} key={"items_"+i}>{e}</Item>)}
    </div>
    <div className={style.page_small_view_container}>
    
       {
        (()=>{
          ...
          return (ps).map((_,i)=>{
              if(i==currentPage-1)
                return <div key={"pages_views_"+i} className={style.page_small_view_selected} ></div>
              
              return <div key={"pages_views_"+i} className={style.page_small_view}></div>;
            })
        })()
      }
    </div>
 
    <div ref={right} className={dir.right} onClick={(e)=>{
      ...
      <div className={style.icon}><img src={dir.right_photo} /></div>
    </div>
    <div ref={left} className={dir.left} onClick={(e)=>{
      ...
      <div className={style.icon}><img src={dir.left_photo} /></div>
    </div>
  </div>
}
